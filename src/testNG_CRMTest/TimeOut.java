...
//********************************************************************************************	
	@Test(priority = 1, timeOut = 20000, groups = "Regrassion Test")						//[1]
...
//********************************************************************************************	
	@Test(priority = 2, groups = {"Regrassion Test","Sanity test"})					//[2]
...
//********************************************************************************************	
	...
	@Test(priority = 3, groups = {"Regrassion Test","Sanity test"})		 			//[3]
	public void paymentTest ()
	{
		System.out.println("payment completed");
	}
//********************************************************************************************	
	@Test(priority = 4, groups = "Regrassion Test")								 	 //[4]
